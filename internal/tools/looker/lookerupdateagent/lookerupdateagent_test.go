...
import (
	...
	lkr "github.com/googleapis/mcp-toolbox/internal/tools/looker/lookerupdateagent"
...
func TestManifest(t *testing.T) {
	...
	expectedParams := []string{"agent_id", "name", "instructions", "sources", "code_interpreter"}
